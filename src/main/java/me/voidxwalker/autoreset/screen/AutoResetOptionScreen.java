...
public class AutoResetOptionScreen extends Screen {
    ...
    public void method_2224() {
        ...
        this.method_2219(new ClickableWidget(340, this.field_2561 / 2 + 5, this.field_2559 - 100, 150, 20, "Is Hardcore: " + isHardcore));
        this.method_2219(new ClickableWidget(341, this.field_2561 / 2 - 155, this.field_2559 - 100, 150, 20, new TranslatableTextContent("selectWorld.mapType").method_0_5147() + " " + I18n.translate(LevelGeneratorType.TYPES[generatorType].getTranslationKey())));
        this.method_2219(new ClickableWidget(342, this.field_2561 / 2 - 155, this.field_2559 - 64, 150, 20, new TranslatableTextContent("selectWorld.mapFeatures").method_0_5147() + " " + structures));
        this.method_2219(new ClickableWidget(344, this.field_2561 / 2 + 5, this.field_2559 - 64, 150, 20, new TranslatableTextContent("selectWorld.bonusItems").method_0_5147() + " " + bonusChest));
        this.method_2219(new ClickableWidget(345, this.field_2561 / 2 - 155, this.field_2559 - 28, 150, 20, Atum.getTranslation("menu.done", "Done").method_0_5147()));
        this.method_2219(new ClickableWidget(343, this.field_2561 / 2 + 5, this.field_2559 - 28, 150, 20, I18n.translate("gui.cancel")));
    }
    ...
    public void method_2214(int mouseX, int mouseY, float delta) {
        this.method_2240();
        this.method_1789(this.field_2563.field_1772, this.title, this.field_2561 / 2, this.field_2559 - 210, -1);
        this.method_1780(this.field_2563.field_1772, "Seed (Leave empty for a random Seed)", this.field_2561 / 2 - 100, this.field_2559 - 180, -6250336);
    ...
    @Override
    protected void method_0_2773(char character, int code) {
        if (this.seedField.method_1871()) {
            this.seedField.method_0_2506(character, code);
