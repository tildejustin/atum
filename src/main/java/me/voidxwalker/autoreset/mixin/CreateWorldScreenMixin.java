...
public abstract class CreateWorldScreenMixin extends Screen {
    ...
    private void createLevel() {
        ...
        LevelInfo levelInfo = new LevelInfo(l, LevelInfo.class_1934.method_8385(this.gameMode), Atum.structures, this.hardcore, LevelGeneratorType.TYPES[Atum.generatorType]);
